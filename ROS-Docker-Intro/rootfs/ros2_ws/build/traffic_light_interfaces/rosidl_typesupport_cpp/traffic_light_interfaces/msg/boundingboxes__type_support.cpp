...
static const _Boundingboxes_type_support_symbol_names_t _Boundingboxes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, traffic_light_interfaces, msg, Boundingboxes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, traffic_light_interfaces, msg, Boundingboxes)),
  }
};
...
{
  return &::traffic_light_interfaces::msg::rosidl_typesupport_cpp::Boundingboxes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, traffic_light_interfaces, msg, Boundingboxes)() {
  return get_message_type_support_handle<traffic_light_interfaces::msg::Boundingboxes>();
}
