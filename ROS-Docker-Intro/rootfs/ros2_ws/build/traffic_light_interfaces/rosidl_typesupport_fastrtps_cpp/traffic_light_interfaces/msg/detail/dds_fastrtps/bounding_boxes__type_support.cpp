...
#include "traffic_light_interfaces/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const traffic_light_interfaces::msg::BoundingBox &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        traffic_light_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const traffic_light_interfaces::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<traffic_light_interfaces::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  return &traffic_light_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
