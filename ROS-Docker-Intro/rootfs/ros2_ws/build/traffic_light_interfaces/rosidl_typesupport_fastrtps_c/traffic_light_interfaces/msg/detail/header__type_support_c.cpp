...
#include "traffic_light_interfaces/msg/detail/header__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_traffic_light_interfaces
...
using _Header__ros_msg_type = traffic_light_interfaces__msg__Header;
...
static uint32_t _Header__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_traffic_light_interfaces__msg__Header(
...
{
  return max_serialized_size_traffic_light_interfaces__msg__Header(
    full_bounded, 0);
}
