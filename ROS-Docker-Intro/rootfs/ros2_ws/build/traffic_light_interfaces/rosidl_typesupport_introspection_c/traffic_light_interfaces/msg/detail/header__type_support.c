  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  traffic_light_interfaces__msg__Header__init(message_memory);
}

void Header__rosidl_typesupport_introspection_c__Header_fini_function(void * message_memory)
{
  traffic_light_interfaces__msg__Header__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Header__rosidl_typesupport_introspection_c__Header_message_member_array[2] = {
  {
    ...
    offsetof(traffic_light_interfaces__msg__Header, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(traffic_light_interfaces__msg__Header, frame_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Header__rosidl_typesupport_introspection_c__Header_message_members = {
  ...
  "Header",  // message name
  2,  // number of fields
  sizeof(traffic_light_interfaces__msg__Header),
