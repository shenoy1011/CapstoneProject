...
static const _BBoxCenter_type_support_symbol_names_t _BBoxCenter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, traffic_light_interfaces, msg, BBoxCenter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, traffic_light_interfaces, msg, BBoxCenter)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, traffic_light_interfaces, msg, BBoxCenter)() {
  return &::traffic_light_interfaces::msg::rosidl_typesupport_c::BBoxCenter_message_type_support_handle;
}
