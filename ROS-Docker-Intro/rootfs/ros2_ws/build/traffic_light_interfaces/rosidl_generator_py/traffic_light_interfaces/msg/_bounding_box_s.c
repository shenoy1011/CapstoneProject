...
bool traffic_light_interfaces__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("traffic_light_interfaces.msg._bounding_box.BoundingBox", full_classname_dest, 54) == 0);
  }
  traffic_light_interfaces__msg__BoundingBox * ros_message = _ros_message;
  {  // probability
  ...
  {  // group
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int16_t * dest = ros_message->group.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'group'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * traffic_light_interfaces__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("traffic_light_interfaces.msg._bounding_box");
  ...
  {  // group
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "group");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->group.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int16_t * src = &(ros_message->group.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->group.size * sizeof(int16_t));
      assert(data != NULL);
