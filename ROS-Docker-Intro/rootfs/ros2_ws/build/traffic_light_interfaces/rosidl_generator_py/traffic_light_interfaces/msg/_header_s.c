...
bool traffic_light_interfaces__msg__header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("traffic_light_interfaces.msg._header.Header", full_classname_dest, 43) == 0);
  }
  traffic_light_interfaces__msg__Header * ros_message = _ros_message;
  {  // stamp
...
PyObject * traffic_light_interfaces__msg__header__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("traffic_light_interfaces.msg._header");
