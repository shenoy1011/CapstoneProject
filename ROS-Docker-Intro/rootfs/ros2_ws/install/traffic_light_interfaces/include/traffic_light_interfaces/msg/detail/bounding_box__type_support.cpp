...
size_t size_function__BoundingBox__group(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int16_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__BoundingBox__group(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__BoundingBox__group(void * untyped_member, size_t index)
{
  auto & member =
...
void resize_function__BoundingBox__group(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int16_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox_message_member_array[7] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(traffic_light_interfaces::msg::BoundingBox, group),  // bytes offset in struct
    nullptr,  // default value
    size_function__BoundingBox__group,  // size() function pointer
    get_const_function__BoundingBox__group,  // get_const(index) function pointer
    get_function__BoundingBox__group,  // get(index) function pointer
    resize_function__BoundingBox__group  // resize(index) function pointer
  }
};
