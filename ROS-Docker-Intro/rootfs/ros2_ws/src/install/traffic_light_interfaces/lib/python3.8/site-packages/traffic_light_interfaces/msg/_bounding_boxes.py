    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'traffic_light_interfaces.msg.BoundingBoxes')
            logger.debug(
            ...
            from traffic_light_interfaces.msg import BoundingBox
...
class BoundingBoxes(metaclass=Metaclass_BoundingBoxes):
    ...
    _fields_and_field_types = {
        ...
        'bounding_boxes': 'sequence<traffic_light_interfaces/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['traffic_light_interfaces', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['traffic_light_interfaces', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['traffic_light_interfaces', 'msg'], 'BoundingBox')),  # noqa: E501
    )
