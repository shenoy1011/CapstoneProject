...
#include <stddef.h>
#include "traffic_light_interfaces/msg/detail/bounding_boxes__rosidl_typesupport_introspection_c.h"
...
#include "traffic_light_interfaces/msg/bounding_box.h"
// Member `bounding_boxes`
#include "traffic_light_interfaces/msg/detail/bounding_box__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  traffic_light_interfaces__msg__BoundingBoxes__init(message_memory);
}

void BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_fini_function(void * message_memory)
{
  traffic_light_interfaces__msg__BoundingBoxes__fini(message_memory);
}

size_t BoundingBoxes__rosidl_typesupport_introspection_c__size_function__BoundingBox__bounding_boxes(
  const void * untyped_member)
{
  const traffic_light_interfaces__msg__BoundingBox__Sequence * member =
    (const traffic_light_interfaces__msg__BoundingBox__Sequence *)(untyped_member);
  return member->size;
}
...
{
  traffic_light_interfaces__msg__BoundingBox__Sequence * member =
    (traffic_light_interfaces__msg__BoundingBox__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  traffic_light_interfaces__msg__BoundingBox__Sequence * member =
    (traffic_light_interfaces__msg__BoundingBox__Sequence *)(untyped_member);
  traffic_light_interfaces__msg__BoundingBox__Sequence__fini(member);
  return traffic_light_interfaces__msg__BoundingBox__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_member_array[3] = {
  {
    ...
    offsetof(traffic_light_interfaces__msg__BoundingBoxes, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(traffic_light_interfaces__msg__BoundingBoxes, image_header),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(traffic_light_interfaces__msg__BoundingBoxes, bounding_boxes),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_members = {
  ...
  3,  // number of fields
  sizeof(traffic_light_interfaces__msg__BoundingBoxes),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, traffic_light_interfaces, msg, BoundingBoxes)() {
  ...
  BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, traffic_light_interfaces, msg, BoundingBox)();
