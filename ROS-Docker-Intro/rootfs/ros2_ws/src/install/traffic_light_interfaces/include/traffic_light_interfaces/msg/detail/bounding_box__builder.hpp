...
class Init_BoundingBox_signaltype
{
public:
  explicit Init_BoundingBox_signaltype(::traffic_light_interfaces::msg::BoundingBox & msg)
  : msg_(msg)
  {}
  ::traffic_light_interfaces::msg::BoundingBox signaltype(::traffic_light_interfaces::msg::BoundingBox::_signaltype_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_BoundingBox_signaltype id(::traffic_light_interfaces::msg::BoundingBox::_id_type arg)
  {
    msg_.id = std::move(arg);
    return Init_BoundingBox_signaltype(msg_);
  }
