...
#include "rosidl_runtime_c/string.h"  // signaltype
#include "rosidl_runtime_c/string_functions.h"  // signaltype
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->signaltype;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: signaltype
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->signaltype.data) {
      rosidl_runtime_c__String__init(&ros_message->signaltype);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->signaltype,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'signaltype'\n");
      return false;
    }
  }
