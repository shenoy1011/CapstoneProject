...
#include "traffic_light_interfaces/msg/detail/b_box_centers__rosidl_typesupport_fastrtps_c.h"
...
#include "traffic_light_interfaces/msg/detail/b_box_center__functions.h"  // bbox_centers
#include "traffic_light_interfaces/msg/detail/header__functions.h"  // header, image_header
...
using _BBoxCenters__ros_msg_type = traffic_light_interfaces__msg__BBoxCenters;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BBoxCenters__ros_msg_type * ros_message = static_cast<const _BBoxCenters__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: bbox_centers
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, traffic_light_interfaces, msg, BBoxCenter
      )()->data);
    size_t size = ros_message->bbox_centers.size;
    auto array_ptr = ros_message->bbox_centers.data;
  ...
  void * untyped_ros_message)
{
  ...
  _BBoxCenters__ros_msg_type * ros_message = static_cast<_BBoxCenters__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: bbox_centers
  {
    ...
    if (ros_message->bbox_centers.data) {
      traffic_light_interfaces__msg__BBoxCenter__Sequence__fini(&ros_message->bbox_centers);
    }
    if (!traffic_light_interfaces__msg__BBoxCenter__Sequence__init(&ros_message->bbox_centers, size)) {
      return "failed to create array for field 'bbox_centers'";
    }
    auto array_ptr = ros_message->bbox_centers.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
size_t get_serialized_size_traffic_light_interfaces__msg__BBoxCenters(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BBoxCenters__ros_msg_type * ros_message = static_cast<const _BBoxCenters__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name bbox_centers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_traffic_light_interfaces__msg__BBoxCenter(
...
static uint32_t _BBoxCenters__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_traffic_light_interfaces__msg__BBoxCenters(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_traffic_light_interfaces
size_t max_serialized_size_traffic_light_interfaces__msg__BBoxCenters(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: bbox_centers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_traffic_light_interfaces__msg__BBoxCenter(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_traffic_light_interfaces__msg__BBoxCenters(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_BBoxCenters = {
...
static rosidl_message_type_support_t _BBoxCenters__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BBoxCenters,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, traffic_light_interfaces, msg, BBoxCenters)() {
  return &_BBoxCenters__type_support;
}
